...
public class EquipmentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
	    ...
	    String cp = request.getContextPath(); // dynamic context path
	    ...
	    out.println("</div>");
	    out.println("<ul>");
	    out.println("<li><a href='" + cp + "/frontend/dashboard.html'>Dashboard</a></li>");
	    out.println("<li><a href='" + cp + "/frontend/equipment.html'>Equipment</a></li>");
	    out.println("<li><a href='" + cp + "/frontend/booking.html'>Bookings</a></li>");
	    out.println("<li><a href='" + cp + "/frontend/login.html'>Logout</a></li>");
	    out.println("</ul>");
	    out.println("</nav>");
	    ...
	    try {
	        ...
	        while (rs.next()) {
	            ...
	            out.println("<p><b>Price :</b> ₹" + rs.getInt("price") + " / Day</p>");
	            out.println("<p><b>Owner :</b> " + rs.getString("owner") + "</p>");
	            out.println("<a href='" + cp + "/frontend/booking.html'>");
